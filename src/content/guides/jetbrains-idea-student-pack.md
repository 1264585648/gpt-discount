...
steps:
  ...
  - title: "选择身份验证方式"
    description: "申请表支持三种主要方式：学校官方邮箱、ISIC/ITIC 会员信息，或 GitHub Student Developer Pack。已经完成 GitHub 学生包时，可选择 Authorize with GitHub，并登录已通过 GitHub Education 认证的同一个 GitHub 账号授权。"
  ...
  - title: "单独检查 JetBrains AI 权益"
    description: "免费学生教育授权包含 IDE 和 .NET 工具，但不包含 JetBrains AI Pro。需要 AI Assistant 或 Junie 时，在 IDE 的 AI Chat 或 JetBrains AI 设置中查看当前可用计划；部分受支持的 IDE、版本和地区可能提供 AI Free，额度以账号实际显示为准。"
...
faq:
  ...
  - question: "JetBrains AI Assistant 或 Junie 也免费吗？"
    answer: "教育版 All Products Pack 不包含 AI Pro。部分 IDE、版本和地区可能提供额度较小的 AI Free，实际可用计划和额度以 IDE 与 JetBrains Account 显示为准。"
